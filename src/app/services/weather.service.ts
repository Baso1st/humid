...
export class WeatherService {
  ...
  getWeather(latitude: number, longitude: number): Observable<WeatherPoint> {
    ...
    return this.http.get<WeatherPoint>(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&units=imperial&APPID=d69052cdbbbf76ae897e756a1d311594`);
  }
}
